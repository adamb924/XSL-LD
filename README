...
The README shows an xsltproc command that will apply the transformation, but I recommend XSLExpress (https://github.com/adamb924/XSLExpress) if you're going to be doing XSL transformations routinely.
